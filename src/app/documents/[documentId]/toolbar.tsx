...
/*
 * @Author: sutengfei
 * @Date: 2024-12-11 15:31:07
 * @LastEditors: sutengfei
 * @LastEditTime: 2024-12-13 18:34:37
 */
import {
  AlignCenterIcon,
  AlignJustifyIcon,
...
const LineHeightButton = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className=" z-50 flex flex-col rounded-sm  bg-white mt-[6px]">
        {lineHeights.map(({ label, value }) => (
          <button
            key={value}
            onClick={() => editor?.chain().focus().setLineHeight(value).run()}
            className={cn(
              "flex items-center gap-x-2 px-3 py-2 hover:bg-neutral-200/80",
  ...
  return (
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent className="z-50 bg-[#fff] rounded-sm shadow mt-[6px]">
          <DropdownMenuItem
            className="flex h-10 items-center cursor-pointer hover:bg-neutral-200/80 p-3"
            onClick={onUpload}
          >
